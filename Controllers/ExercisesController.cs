...
namespace WebApplication1.Controllers
{
    public class ExercisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Weight,Reps,Series,SessionId,ExerciseTypeId,UserId")] Exercise exercise)
        {
            if (ModelState.IsValid)
            {
                // Przypisz UserId na podstawie bieżącego użytkownika
                exercise.UserId = User.FindFirst(ClaimTypes.NameIdentifier)?.Value;
